 ...
 * y restablece su estado visual (elimina la clase is-invalid que elimina el borde rojo).
 ...
 * @param {HTMLInputElement} input - El campo para el cual se eliminarían los mensajes de error
 */
